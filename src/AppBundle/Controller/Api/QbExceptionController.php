...
class QbExceptionController extends Controller {
    ...
    public function newAction($id, Request $request) {      
        ...
        return new JsonResponse("Added QuickBooks Exception");
    }
    ...
    */
    ...
    private function createExportExcel($qbExceptionsForExport) {
        ...
        $phpExcelObject->setActiveSheetIndex(0)
                ...
                ->setCellValue('G1', 'QuickBooks Transaction type')
    ...
    private function emailErrors(\PHPExcel $phpExcelObject, $type, $email, $name, $isSuccessful){
        ...
        $fileName = 'ImportExceptionsReport';
        $fileName .= '.xls';
        ...
        $message = (new \Swift_Message("QuickBooks Import Results"))
